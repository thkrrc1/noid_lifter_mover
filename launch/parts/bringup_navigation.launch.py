...
def generate_launch_description():
    ...
    declare_map_yaml_cmd = DeclareLaunchArgument(
        'map',
        default_value=PathJoinSubstitution([robot_pkg, 'config', 'navigation', 'map', 'scan_map.yaml']),
    ...
    declare_slam_toolbox_params_cmd = DeclareLaunchArgument(
        ...
        default_value=PathJoinSubstitution([robot_pkg, 'config', 'navigation', 'slam_toolbox.yaml']),
        description='Full path to the slam_toobox parameter file',
    )

    declare_localization_params_cmd = DeclareLaunchArgument(
        'localization_params_file',
        default_value=PathJoinSubstitution([robot_pkg, 'config', 'navigation', 'localization.yaml']),
        description='Full path to the localization parameter file',
    )

    declare_navigation_params_cmd = DeclareLaunchArgument(
        'navigation_params_file',
        default_value=PathJoinSubstitution([robot_pkg, 'config', 'navigation', 'navigation.yaml']),
    ...
    bringup_cmd_group = GroupAction(
        [
            ...
            IncludeLaunchDescription(
                PythonLaunchDescriptionSource(
                    PathJoinSubstitution([robot_pkg, 'launch', 'parts','navigation.launch.py'])
                ),
                launch_arguments={
                    'namespace': namespace,
                    'use_sim_time': use_sim_time,
    ...
    ld.add_action(declare_navigation_params_cmd)
